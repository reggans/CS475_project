...
if __name__ == "__main__":
    ...
    if args.regions is None:
        ...
        if args.shorten:
            posthoc_shorten_answer(f"{args.home_dir}/probable_data/categories_nationality_{args.num_samples}_{args.model_name}_moe_prob={args.probably}.json", args.topic_list, rewrite=args.rewrite, model_name=model_name, batch=args.batch)