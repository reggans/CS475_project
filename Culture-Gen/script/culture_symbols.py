...
def extract_all_symbols_from_generation(home_dir, shortened_data_path, save_path, topic_list=None, r="neighbor", rewrite=False):
    ...
    for a, topic in enumerate(tqdm(topic_list, desc="Assessing topic")):
        ...
        for b, role in enumerate(tqdm(category_nationality_dict[topic], desc="Assesing role")):
...
if __name__ == "__main__":
    ...
    if args.topic_list == None:
        ...
        args.topic_list = ["favorite_music", "music_instrument", "exercise_routine", "favorite_show_or_movie", "food", "clothing"]
